...
$rqz=mysqli_query($conn,"insert into attente(prix,datedebut,datefin,numclient) values('$prix','$dated','$datef','$numcli')"); 
      ...
      // else $mess2="<b>si la mise en liste d'attente échoué </b>";
     }
?>
<?php 
//supprimer
...
<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="POST" >
  <table align="">
   ...
   <tr><td></td><td><strong>Prix journée :</strong></td></tr>
